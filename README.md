...
### Детектирование линий преобразованием Хафа
На маскированной edge map применяется `cv::HoughLinesP`. 
Параметры:
- rho = 1 (пиксели)
- theta = 1°
- threshold = 50
